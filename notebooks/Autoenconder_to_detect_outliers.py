...
#%% Definir limiar para detectar anomalias (ex: percentil 95 do erro dos normais)
limiar = np.percentile(reconstruction_error, 95)
...
#%% Remover outliers
indices_para_dropar = df_train_with_outliers_features.index[df_train_with_outliers_features['isOutlier'] == 1]
df_train_without_new_outliers = df_train_with_outliers_features.drop(indices_para_dropar)
